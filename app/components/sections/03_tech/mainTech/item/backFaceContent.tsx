...
export default function BackFaceContent({ src, alt }: ITechLogo) {
    return (
        <div className='group w-full h-full relative overflow-hidden rounded-lg'>
            ...
            <p className='absolute h-full w-full top-full bg-primary p-4 text-tertiary rounded-sm text-center text-sm sm:text-lg group-hover:top-0 transition-all duration-700 flex justify-center items-center'>
                {alt}
            </p>
        </div>
    );
